...
public final class ProcessingReconciliation {
    ...
    /**
     * Enqueue a job for every candidate the knowledge project has never processed.
     *
     * @param processedSourceIds source ids owning at least one capture in the knowledge
     *                           project (processed under some identity — not our gap)
    ...
    public static int reconcile(Iterable<? extends CandidateSource> candidates,
                                Set<String> processedSourceIds, MissingJobScheduler scheduler) {
        int enqueued = 0;
