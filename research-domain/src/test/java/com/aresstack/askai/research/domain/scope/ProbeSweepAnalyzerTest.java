 ...
 * a "hole" however novel it is; relevant probes bucket as KNOWN/EXCLUDED/BOUNDARY/UNEXPLORED; five
 * wordings of the same unknown topic collapse to ONE diverse candidate; two separate unknown islands
 * both survive. No coverage percentage exists anywhere.
 */
public class ProbeSweepAnalyzerTest {
    ...
    private static final double MIN_RELEVANCE = 0.3d;
    ...
    public void theTwoAxesBucketEveryAgreedCase() {
        ...
        ProbeSweepResult result = ProbeSweepAnalyzer.analyze(
                probes, MISSION, fence(), FENCE, MIN_RELEVANCE);
