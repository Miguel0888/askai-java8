...
/**
 * Immutable, framework-free description of a chat <em>agent</em> plugin. Unlike a workspace, an agent does not
 * replace the chat — it contributes slash commands, artifacts and specialized views to the shared AskAI chat.
 * This descriptor carries only the metadata the host needs to list, order and validate an agent; no Swing,
 * PF4J or classloader type appears here.
 *
 * <p>All string fields are trimmed. {@code id} must be a stable reverse-domain-style identifier and
 * {@code pluginApiVersion} must be &ge; 1.</p>
 */
public final class AgentPluginDescriptor {
    ...
    private AgentPluginDescriptor(Builder builder) {
    ...
    public static final class Builder {
        ...
        public AgentPluginDescriptor build() {
            return new AgentPluginDescriptor(this);
        }
    }
}
