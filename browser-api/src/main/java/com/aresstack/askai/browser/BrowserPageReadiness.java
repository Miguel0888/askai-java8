...
public final class BrowserPageReadiness {
    ...
    /** A manual challenge (CAPTCHA / "one last step") is present — the page cannot be read until solved. */
    public final boolean challengePresent;
    /** The marker that matched the challenge (selector/text), or "" when none. */
    ...
    public static BrowserPageReadiness parse(String rendered) {
        ...
        return new BrowserPageReadiness(url, title, textLength, excerpt, challenge, challengeMarker,
