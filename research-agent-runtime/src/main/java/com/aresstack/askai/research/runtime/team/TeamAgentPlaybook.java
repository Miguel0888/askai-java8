...
public final class TeamAgentPlaybook {
    ...
    public static String scopingSystemPrompt() {
        return "You are a helpful research assistant inside AskAI. You sit BESIDE the user to help them work "
                ...
                + "detail NEVER prevents you from helping.\n"
                ...
                + "accept or correct as a whole: the main research question in one sentence, 3-6 sub-aspects "
                + "it covers, and the exclusions the user named. Then STOP — no \"which of these would you "
                ...
                + "- Offer a SEARCH SUGGESTION only when a lookup would genuinely help right now. Zero "
                + "suggestions is a perfectly normal turn — never invent one to fill the field.\n"
