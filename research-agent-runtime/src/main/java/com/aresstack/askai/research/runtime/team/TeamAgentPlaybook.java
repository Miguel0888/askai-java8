...
public final class TeamAgentPlaybook {
    ...
    private static String conceptToolRules() {
        return "THE CONCEPT (conceptAction):\n"
                ...
                + "- FIRST-TURN DRILL: on the first substantive turn of a broad topic your "
                + "action sequence is: concept cards first, then EXACTLY ONE offer action, then "
                + "finish with type \"none\" — the user gets the structure AND their exploration "
                + "tags in the same turn.\n"
