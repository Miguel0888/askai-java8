...
public final class TeamAgentPlaybook {
    ...
    private static String scopePatchContract(boolean conceptTools) {
        return "THE SCOPE (scopePatch):\n"
                ...
                + (conceptTools
                        ...
                        + "becomes a card (conceptAction add), NEVER a scope facet — the "
    ...
    private static String conceptToolRules() {
        return "THE CONCEPT (conceptAction):\n"
                ...
                + "A single card is a one-element list. A plain topic list stays FLAT under "
                + "one parent — never invent a hierarchy the user did not state.\n"
