...
public final class TeamAgentPlaybook {
    ...
    public static String scopingSystemPrompt() {
        return "You are a helpful research assistant inside AskAI. You sit BESIDE the user to help them work "
                ...
                + "- When it helps, offer an EXPLORATION MAP as a Mermaid mindmap from your own general "
                + "knowledge to open up the idea space. Provide only the Mermaid body (no code fences). It is "
                + "an unverified idea map, not confirmed evidence.\n"
                ...
                + "  \"explorationMapMermaid\": string,   // optional: a BARE Mermaid mindmap body (no code "
                + "fences)\n"
                + "  \"searchSuggestions\": [             // optional: short engine queries, separate from the "
                + "question\n"
